...
import {authorize, ADMIN, LOGGED_USER} from '../../middlewares/auth.mjs';
import {listUsers, createUser, replaceUser, updateUser} from '../../validations/user.validation.mjs';
...
/**
   ...
   * @apiPermission user
   *
   * @apiHeader {String} Authorization   User's access toke
   * @apiParam {Number{1-}} id Users unique ID.
   *
   * @apiSuccess {String}  id         User's id
   * @apiSuccess {String}  name       User's name
   * @apiSuccess {String}  email      User's email
